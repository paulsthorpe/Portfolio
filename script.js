...
$(document).ready(function(){
    // $('.page_container').hide();
    // $('.gearLoadSpace').hide();
    // $('.gearLoadSpace').fadeIn(800).delay(3000).fadeOut(800);
    // $('.page_container').delay(3800).fadeIn(1500);
    // animateGears();
...
//   //gear animation
//   var rotateFactor = 360;
//   var rotateCounter = 0;
//   $('.gear-sm').css('transform', 'rotate('+(rotateFactor * -2)+'deg)');
//   $('.gear-md').css('transform', 'rotate('+(rotateFactor * 2)+'deg)');
// //   setInterval(function(){
// //   if(rotateCounter<5){
// //     console.log('begin');
// //     rotateFactor = rotateFactor+360;
// //     $('.gear-sm').css('transform', 'rotate('+(rotateFactor * -1)+'deg)');
// //     $('.gear-md').css('transform', 'rotate('+rotateFactor+'deg)');
// //     rotateCounter++;
// //     console.log('end' + rotateCounter);
// //   }
// // }, 2000);
//
//
